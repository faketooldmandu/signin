...
<div id="wporg-header">
	<div class="wrapper">
<a class="skip-link screen-reader-text" href="#home-welcome">Skip to content</a>	<h1><a href="//wordpress.org">WordPress.org</a></h1>				<div id="head-search">
...
<section class="intro">
	...
	<div class="screenshots">
		<img src="https://s.w.org/images/home/screen-themes.png?4" class="dashboard" alt="" />
		<img src="https://s.w.org/images/home/mobile-themes.png?4" class="dashboard-mobile" alt="" />
	</div>
</section>

<section class="showcase">
	<h2>Trusted by the Best</h2>
	<p class="subheading">41% of the web uses WordPress, from hobby blogs to the biggest news sites online.</p>
	<div class="collage">
...
<a href="https://mercantile.wordpress.org/"><img width="132" height="177" src="https://s.w.org/images/home/swag_col-1.jpg?1" alt="WordPress Swag" /></a>
		...
		<div class="col-4">
			...
			<h5><a href="https://wordpress.org/news/2021/06/wordpress-5-8-beta-1/">WordPress 5.8 Beta 1</a></h5>
		...
		<div class="col-4">
			...
			<ol class="steps">
				...
				<li class="three"><span></span><a href="https://wordpress.org/support/">Spend some time reading our documentation</a>, get to know WordPress better every day and start helping others,&nbsp;too.</li>
		...
		<div class="col-2">
			...
			<ul id="notable-users">
				<li><a href='https://wordpress.org/showcase/rolling-stone/'><img src='https://s.w.org/images/notableusers/rolling-stone-2x.png?version=2' loading='lazy' alt='rolling-stone' width='130' height='57' /></a></li><li><a href='https://wordpress.org/showcase/the-white-house/'><img src='https://s.w.org/images/notableusers/whitehouse-2x.png?version=2' loading='lazy' alt='whitehouse' width='130' height='57' /></a></li><li><a href='https://wordpress.org/showcase/bbc-america/'><img src='https://s.w.org/images/notableusers/bbc-america-2x.png?version=2' loading='lazy' alt='bbc-america' width='130' height='57' /></a></li>			</ul>
